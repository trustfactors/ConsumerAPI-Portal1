                ...
                completionBlock:(CompletedGetmerchants) onCompleted
{
    ...
    [_queryBuilder appendString: @"/merchants"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             NSArray<Merchant> * _result = (NSArray<Merchant>*) [Merchant arrayOfModelsFromDictionaries:
                ...
                completionBlock:(CompletedGetmerchant) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/merchants/{id}"];

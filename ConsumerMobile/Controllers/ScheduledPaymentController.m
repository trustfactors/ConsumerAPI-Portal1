...
@implementation ScheduledPaymentController
                ...
                completionBlock:(CompletedGetscheduledPayments) onCompleted
{
    ...
    [_queryBuilder appendString: @"/scheduled_payments"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             NSArray<ScheduledPayment> * _result = (NSArray<ScheduledPayment>*) [ScheduledPayment arrayOfModelsFromDictionaries:
                ...
                completionBlock:(CompletedGetscheduledPayment) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/scheduled_payments/{id}"];

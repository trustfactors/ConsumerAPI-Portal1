...
@implementation CashbackController
                ...
                completionBlock:(CompletedGetcashbacks) onCompleted
{
    ...
    [_queryBuilder appendString: @"/cashbacks"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             NSArray<Cashback> * _result = (NSArray<Cashback>*) [Cashback arrayOfModelsFromDictionaries:
                ...
                completionBlock:(CompletedGetcashback) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/cashbacks/{id}"];

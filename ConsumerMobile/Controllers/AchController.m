...
//
#import "AchController.h"

@implementation AchController
                ...
                completionBlock:(CompletedGetaches) onCompleted
{
    ...
    [_queryBuilder appendString: @"/aches"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             NSArray<Ach> * _result = (NSArray<Ach>*) [Ach arrayOfModelsFromDictionaries:
                ...
                completionBlock:(CompletedGetach) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/aches/{id}"];

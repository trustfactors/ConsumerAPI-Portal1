                ...
                completionBlock:(CompletedGetstatements) onCompleted
{
    ...
    [_queryBuilder appendString: @"/statements"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             NSArray<Statement> * _result = (NSArray<Statement>*) [Statement arrayOfModelsFromDictionaries:
                ...
                completionBlock:(CompletedGetstatement) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/statements/{id}"];
                ...
                completionBlock:(CompletedGettransactionsS1) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/statements/{id}/transactions"];

                ...
                completionBlock:(CompletedGetcreditCards) onCompleted
{
    ...
    [_queryBuilder appendString: @"/credit_cards"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             NSArray<CreditCard> * _result = (NSArray<CreditCard>*) [CreditCard arrayOfModelsFromDictionaries:
                ...
                completionBlock:(CompletedGetcreditCard) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/credit_cards/{id}"];
                ...
                completionBlock:(CompletedGettransactionsS) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/credit_cards/{id}/transactions"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             //return _response to API caller
             NSString* _strResult = [(HttpStringResponse*)_response body];
             NSArray<Transaction> * _result = (NSArray<Transaction>*) [Transaction arrayOfModelsFromDictionaries:
                [APIHelper jsonDeserializeArray: _strResult] error: nil];

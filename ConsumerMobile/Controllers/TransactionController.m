                ...
                completionBlock:(CompletedGettransactions) onCompleted
{
    ...
    [_queryBuilder appendString: @"/transactions"];
                ...
                completionBlock:(CompletedGettransaction) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/transactions/{id}"];
                ...
                completionBlock:(CompletedGetdisputesS) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/transactions/{id}/challenges"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             //return _response to API caller
             NSString* _strResult = [(HttpStringResponse*)_response body];
             NSArray<Challenge> * _result = (NSArray<Challenge>*) [Challenge arrayOfModelsFromDictionaries:
                [APIHelper jsonDeserializeArray: _strResult] error: nil];
